...
ca_file="deviceRootCA.pem"
root_cert_path="deviceRootCA.key"
host = "a3njal8wrtnp6k-ats.iot.eu-central-1.amazonaws.com"
port = 8883
ca_file_key="deviceRootCA.key"
...
def generate_x509(cn, c,st,l,o,ou,emailAddress,exp_days):
     keypath =  cn + '.key'
     csrpath =  cn  +  '.csr'
     crtpath =  cn  +  '.crt'
     key = crypto.PKey()
    ...
    #Else write the key to the keyfile
     ...
     if os.path.exists(crtpath):
        ...
        f.close()
        cat("deviceROOT"+crtpath, crtpath,ca_file)
...
generate_x509("dev_test_35w1231233345te","eu","Hamburg","Hamburg","AMT","AMT-UNIT-1","test@gmail.com",3650)
